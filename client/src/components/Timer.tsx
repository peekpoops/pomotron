          ...
          <Card className={getCardClassName()}>
            <CardContent className="p-4 sm:p-6 lg:p-12 xl:p-16 mobile-padding-md">
              ...
              <div className="text-center mb-6 sm:mb-8 lg:mb-12 xl:mb-16 relative z-10 w-full max-w-full px-1 sm:px-2">
                ...
                <div className={`timer-display mobile-timer-large text-6xl sm:text-8xl md:text-[7rem] lg:text-[8rem] xl:text-[10rem] font-orbitron font-black ${getTimerDisplayColor()} mb-6 sm:mb-8 lg:mb-10 leading-none w-full`}>
