        ...
        <div className="xl:col-span-2 lg:col-span-2 w-full">
          <Card className={getCardClassName()}>
            <CardContent className="p-6 sm:p-8 lg:p-12 xl:p-16 mobile-padding-md">
              ...
              {/* Timer Display */}
              <div className="text-center mb-8 lg:mb-12 xl:mb-16 relative z-10 w-full max-w-full px-4 sm:px-6">
                {(timerState.sessionType === 'break' || timerState.sessionType === 'longBreak') && (
                ...
                <div className={`timer-display text-8xl sm:text-9xl md:text-[7rem] lg:text-[8rem] xl:text-[10rem] font-orbitron font-black ${getTimerDisplayColor()} mb-6 lg:mb-8 leading-none mobile-timer-large w-full max-w-full overflow-hidden`}>
